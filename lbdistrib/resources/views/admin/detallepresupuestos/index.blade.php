        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-lg-12">
                <div class="table-responsive">
                    <table class="table table-condensed small table-borderless" style="font-size: smaller">
                        <tr>
                            <td>
                                Razón social
                            </td>
                            ...
                            <td style=" width: 15%" class=" text-center">
                                <a href="{{ route('pedido.descartar', $presupuesto->id) }}" class="btn btn-light btn-block border">
