...
class DetallePresupuestoController extends Controller
{
    public function index(Request $request)
    {
        ...
        $detallepresupuesto = DetallePresupuesto::where('presupuesto', $request->id)->orderBy('id', 'ASC')->get();
    ...
    public function update(Request $request)
    {
        ...
        $total = DetallePresupuesto::where('presupuesto', $id)->sum('cantidadentregada');
        $view = view('admin.detallepresupuestos.detalletotal', compact('total'))->render();
